...
The `[~triggering_user]` mention is replaced with the Jira user who originally
mentioned the bot, so that they receive a notification when the pipeline starts.
